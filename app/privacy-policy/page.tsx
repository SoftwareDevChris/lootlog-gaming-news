      ...
      <div className="mx-auto max-w-1300 text-neutral-200">
        ...
        <div className="p-4 sm:p-8">
          ...
          <p>
            ...
            company and customer feedback. We encourage you to periodically
            review this Policy to be informed of how Loot Log is protecting your
            information.
          </p>
        </div>
        ...
        <div className="p-4 sm:p-8">
          ...
          <p>
            Loot Log welcomes your comments regarding this Privacy Policy. If
            you believe that Loot Log has not adhered to this Policy, please
            contact us at web.chrisr@gmail.com.
          </p>
        </div>
      </div>
    </main>
